...
switch (countryLower) {
  case 'китай':
    console.log(`Доставка в ${countryLower} будет стоить 100 кредитов`);
    break;
  case 'чили':
    console.log(`Доставка в ${countryLower} будет стоить 250 кредитов`);
    break;
  case 'австралия':
    console.log(`Доставка в ${countryLower} будет стоить 170 кредито`);
    break;
  case 'индия':
    console.log(`Доставка в ${countryLower} будет стоить 80 кредито`);
    break;
  case 'ямайка':
    console.log(`Доставка в ${countryLower} будет стоить 120 кредитов`);
    break;
  default:
